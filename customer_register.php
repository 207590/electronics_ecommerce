        ...
        <div class="content_wrapper">
            <div id="content_area">
                ...
                <table align="center" width="750">
                    ...
                    <td><input type="text" name="c_email" required="required"/></td>
                    ...
                    <td>
                    <select name="c_country" required="required">
                    ...
                    <td><input type="text" name="c_city" required="required"/>
                    ...
                    <td><input type="text" name="c_contact" required="required"/></td>
...
if(isset($_POST['register'])){
    ...
    $insert_c = "insert into customers (customer_ip,customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,customer_address,customer_image) values(' $ip ','$c_name','$c_email','$c_pass','$c_country','$c_city','$c_contact','$c_address','$c_address')";
