                ...
                <div id="shopping_cart">
                    <span style="color:white; float:right; font-size:18px; line-height:40px;">
                     ...
                     if(!isset($_SESSION['customer_email'])){
                         ...
                         echo "<b>Welcome:</b>". $_SESSION['customer_email']."<b style='color:#F4A460'>Your</b>";
                     } 
                        else{
                     ...
                     ?>
                        ...
                        <b>Shopping Cart</b>Total items:<?php total_items(); ?> Total Price:Ksh.<?php total_price(); ?> <a href="cart.php" style="color:#F4A460">Go to Cart</a>
