        ...
        <div class="content_wrapper">
            <div id="content_area">
                ...
                <div id="shopping_cart">
                    ...
                    Welcome Quest! <b>Shopping Cart</b>Total items:<?php total_items(); ?> Total Price:Ksh.<?php total_price(); ?> <a href="index.php" style="color:#F4A460">Back to Shop</a>
                    ...
                    if(!isset($_SESSION['customer_email'])){
                        ...
                        echo "<a href='checkout.php' style='color:yellow;'>Login</a>";
                            ...
                            echo "<a href='logout.php' style='color:#ffbf00;>Logout</a>";
                        }
                    ?>    
                ...
                <div id="product_box">
                   ...
                   <form id="form1" action="cart.php" method="post" enctype="multipart/form-data">
                    ...
                    <table align="center" width="700" bgcolor=" #5F9EA0">
            ...
            <?php 
              ...
              while($p_price=mysqli_fetch_array($run_price)){
                 ...
                 <tr align="center">
                     ...
                     <td><input type="text" size="5" name="qty" value=""/></td> 
